// gcc -o test_scroller2 test_scroller2.c `pkg-config --cflags --libs elementary`

#include <Elementary.h>

const char *str_tmp = "scroller focus scroller focus scroller focus scroller " 
...
"focus scroller focus scroller focus scroller focus scroller focus scroller "
"focus scroller focus scroller focus scroller focus scroller focus scroller "
"focus scroller focus scroller I am groot!! focus scroller focus scroller "
"focus scroller focus scroller focus scroller focus scroller focus scroller "
"focus scroller focus scroller focus scroller focus scroller focus scroller "
"focus scroller focus scroller focus scroller focus scroller focus scroller "
"focus scroller focus scroller focus scroller focus scroller focus scroller "
...
elm_main(int argc EINA_UNUSED, char **argv EINA_UNUSED)
{
   ...
   elm_object_text_set(btn, "Goal is to read middle word of label only using arrow key!");
